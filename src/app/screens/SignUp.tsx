      ...
      <div className="px-6 py-6 flex flex-col flex-1">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <User className="absolute left-4 top-1/2 -translate-y-1/2" style={{ color: '#8B86A8', width: '17px', height: '17px' }} />
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input type={showPassword ? 'text' : 'password'} placeholder="••••••••"
              ...
              style={{ paddingLeft: '44px', paddingRight: '44px', borderRadius: '12px', fontFamily: 'Inter, sans-serif', fontSize: '14px', background: '#F7F5FC', border: '1.5px solid rgba(108,63,232,0.12)', outline: 'none', color: '#16143A' }} />
            <button onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2">
              {showPassword ? <EyeOff style={{ color: '#8B86A8', width: '17px', height: '17px' }} /> : <Eye style={{ color: '#8B86A8', width: '17px', height: '17px' }} />}
            </button>
          </div>
        </div>
        ...
        {/* Terms */}
        <p className="text-center mb-5" style={{ fontSize: '12px', color: '#8B86A8', fontFamily: 'Inter, sans-serif', lineHeight: 1.6 }}>
          By signing up, you agree to our{' '}
          <span style={{ color: '#6C3FE8', fontWeight: 600 }}>Terms of Use</span> and{' '}
          <span style={{ color: '#6C3FE8', fontWeight: 600 }}>Privacy Policy</span>
        </p>
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span style={{ fontSize: '12px', color: '#8B86A8', fontFamily: 'Inter, sans-serif' }}>or sign up with</span>
          <div className="flex-1 h-px" style={{ background: 'rgba(108,63,232,0.1)' }} />
        </div>
        ...
        <p className="text-center" style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px' }}>
          <span style={{ color: '#8B86A8' }}>Already have an account? </span>
          <button style={{ color: '#6C3FE8', fontWeight: 700 }}>Log In</button>
        </p>
      </div>
    </div>
  );
